...
class Agents(Agent):
        ...
        async def run(self):
            ...
            if msg:
                ...
                if(msg.body == "igra" and msg.get_metadata('salje') == "gamemaster"):
                    ...
                    odgovor.set_metadata("salje", "kmedenjak_agent4@5222.de")
                    if self.agent.firstMessage:
                        odgovor.body = f"{Probability.prob(30/100)}"
                        ...
                        for o in self.agent.svidaOdgovori:
                            if o == "True":
                                brojTrue += 1
                        vjerojatnost = round(((round(brojTrue / len(self.agent.svidaOdgovori)) * 100) + 30) / 2)
    ...
    async def setup(self):
        print("Agent 4 pokrenut")
        self.behav = self.MyBehav()
        self.add_behaviour(self.behav)

async def main():
    
    agent = Agents("kmedenjak_agent4@5222.de", "12345")
